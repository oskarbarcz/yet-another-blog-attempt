...
export default function CompactEventItem({ title, role, date, city }: CompactEventData) {
  ...
  return (
    <li className="flex items-start justify-between gap-3 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900/50">
      ...
      <div className="flex shrink-0 flex-col items-end gap-1 text-right">
        <RoleBadge role={role} />
        <time className="text-[11px] text-gray-500 dark:text-gray-400" dateTime={d.toISOString()}>
